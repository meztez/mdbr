...
The package bundles the [Northwind Access database][nwind], including related tables,
foreign keys, and non-ASCII names. Find it with `mdb_example()`.
...
[nwind]: https://github.com/mdbtools/mdbtestdata
<!-- refs: end -->
